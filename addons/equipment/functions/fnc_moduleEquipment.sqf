...
private ["_action", "_hideObject", "_type", "_presets", "_presetsArray", "_info", "_classnames", "_presetsOnly", "_insignias", "_users", "_camera", "_nv", "_saveLoad", "_persistent", "_loadVR", "_condition"];
...

{
    if (_x getVariable [format["MEU_Equipment_Action_%1", _type], true]) then {
        ...
        [_type, _hideObject, _camera, _nv, _saveLoad, _persistent, _presets, _presetsArray, _info, _classnames, _presetsOnly, _insignias, _loadVR],
