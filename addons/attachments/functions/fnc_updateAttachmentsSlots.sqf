...
private ["_control_MuzzleButton", "_control_PointerButton", "_control_SightsButton", "_control_BipodButton"];
...
_control_MuzzleButton = _display displayCtrl 8554;
_control_PointerButton = _display displayCtrl 8555;
_control_SightsButton = _display displayCtrl 8556;
_control_BipodButton = _display displayCtrl 8557;
