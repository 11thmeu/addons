...
class RscMEU_Attachments {
    ...
    class controls {
        ...
        class Button_Muzzle: MEU_gui_Button {
            idc = 8554;
            text = "";
            action = QUOTE([2] call FUNC(removeAttachment););
        ...
        class Button_Pointer: MEU_gui_Button {
            idc = 8555;
            text = "";
            action = QUOTE([1] call FUNC(removeAttachment););
            animTextureNormal = "#(argb,8,8,3)color(1,1,1,0)";
            animTextureDisabled = "#(argb,8,8,3)color(1,1,1,0)";
            animTextureOver = "#(argb,8,8,3)color(1,1,1,0)";
            animTextureFocused = "#(argb,8,8,3)color(1,1,1,0)";
        ...
        class Button_Sights: MEU_gui_Button {
            idc = 8556;
            text = "";
            action = QUOTE([0] call FUNC(removeAttachment););
            animTextureNormal = "#(argb,8,8,3)color(1,1,1,0)";
            animTextureDisabled = "#(argb,8,8,3)color(1,1,1,0)";
            animTextureOver = "#(argb,8,8,3)color(1,1,1,0)";
            animTextureFocused = "#(argb,8,8,3)color(1,1,1,0)";
        ...
        class Button_Bipod: MEU_gui_Button {
            idc = 8557;
            text = "";
            action = QUOTE([3] call FUNC(removeAttachment););
            animTextureNormal = "#(argb,8,8,3)color(1,1,1,0)";
            animTextureDisabled = "#(argb,8,8,3)color(1,1,1,0)";
            animTextureOver = "#(argb,8,8,3)color(1,1,1,0)";
            animTextureFocused = "#(argb,8,8,3)color(1,1,1,0)";
