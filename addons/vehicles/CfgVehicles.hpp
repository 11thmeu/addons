class CfgVehicles {    
    ...
    class Truck_F: Car { MEU_SideJump = 0; };
    ...
    class B_Heli_Light_01_F: Heli_Light_01_base_F { MEU_SideJump = 1; };
    ...
    class O_Heli_Light_02_unarmed_F: Heli_Light_02_base_F { MEU_SideJump = 1; };
    ...
    class I_Heli_light_03_F: I_Heli_light_03_base_F { MEU_SideJump = 1; };
    
    class I_Heli_light_03_unarmed_base_F;
    class I_Heli_light_03_unarmed_F: I_Heli_light_03_unarmed_base_F { MEU_SideJump = 1; };
};